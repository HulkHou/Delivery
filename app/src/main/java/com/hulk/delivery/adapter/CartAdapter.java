...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    private List<CartBean.CartlistBean> data;
    private View headerView;
    private OnDeleteClickListener mOnDeleteClickListener;
    private OnEditClickListener mOnEditClickListener;
    private OnResfreshListener mOnResfreshListener;

    public CartAdapter(Context context, List<CartBean.CartlistBean> data) {
    ...
    public void onBindViewHolder(final CartAdapter.MyViewHolder holder, final int position) {
        ...
        if (data.get(position).getIsSelect()) {
            holder.ivShopCartClothSel.setImageDrawable(context.getResources().getDrawable(R.mipmap.ic_cart_selected));
        } else {
            holder.ivShopCartClothSel.setImageDrawable(context.getResources().getDrawable(R.mipmap.ic_cart_unselected));
        }

        if (data.get(position).getIsShopSelect()) {
            holder.ivShopCartShopSel.setImageDrawable(context.getResources().getDrawable(R.mipmap.ic_cart_selected));
        } else {
            holder.ivShopCartShopSel.setImageDrawable(context.getResources().getDrawable(R.mipmap.ic_cart_unselected));
        }
    ...
    private void showDialog(final View view, final int position) {
        ...
        CartHomeFragment.isSelectFirst(data);
        notifyDataSetChanged();
    }
    ...
    public void setOnItemClickListener(CartAdapter.OnItemClickListener mOnItemClickListener) {
